		...
		for i = 1, #currentRace.available_vehicles[classid].vehicles do
			if currentRace.available_vehicles[classid].vehicles[i].aveh then
				if currentRace.available_vehicles[classid].vehicles[i].enabled then
					...
					aveh = SetBitValue(aveh, currentRace.available_vehicles[classid].vehicles[i].aveh)
				end
			elseif currentRace.available_vehicles[classid].vehicles[i].adlc then
				if currentRace.available_vehicles[classid].vehicles[i].enabled then
					found = true
					adlc = SetBitValue(adlc, currentRace.available_vehicles[classid].vehicles[i].adlc)
				end
			elseif currentRace.available_vehicles[classid].vehicles[i].adlc2 then
				if currentRace.available_vehicles[classid].vehicles[i].enabled then
					found = true
					adlc2 = SetBitValue(adlc2, currentRace.available_vehicles[classid].vehicles[i].adlc2)
				end
			elseif currentRace.available_vehicles[classid].vehicles[i].adlc3 then
				if currentRace.available_vehicles[classid].vehicles[i].enabled then
					found = true
					adlc3 = SetBitValue(adlc3, currentRace.available_vehicles[classid].vehicles[i].adlc3)
				end
			end
		end
		if found then
			clbs = SetBitValue(clbs, classid)
		else
